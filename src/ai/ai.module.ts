...
import { AiSpeakingController } from '../modules/ai/controllers/ai-speaking.controller';
import { AiVocabularyController } from '../modules/ai/controllers/ai-vocabulary.controller';
...
/**
 * All /api/v1/ai/* routes are registered here:
 * - tutor, pronunciation (legacy)
 * - vocabulary, speaking (Phase-2C content pipeline)
 */
@Module({
  imports: [GamificationModule, CacheModule, ContentPipelineModule],
  controllers: [
    AiController,
    TutorController,
